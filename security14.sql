...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 30 2026 г., 18:03
...
--
-- База данных: `security14`
--

-- --------------------------------------------------------

--
-- Структура таблицы `access_ip`
--
...
INSERT INTO `users` (`id`, `login`, `password`, `roll`, `attempt`) VALUES
(1, 'admin', 'Asdfg123', 1, 1),
(8, 'user', 'Asdfg123', 0, 0),
(1401, 'KrisGo', 'password', 0, NULL);
...
--
-- AUTO_INCREMENT для таблицы `access_ip`
--
ALTER TABLE `access_ip`
...
--
ALTER TABLE `comments`
  MODIFY `Id` int NOT NULL AUTO_INCREMENT COMMENT 'Код', AUTO_INCREMENT=805;
...
--
ALTER TABLE `users`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1402;
COMMIT;
